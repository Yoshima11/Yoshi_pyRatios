...
def main(page: ft.Page):
    ...
    def calcula_ratio(e):
        ...
        try:
            historico_activo1 = fa.rava.get_history(
                ticker1.value,
                fecha_ini.value,
                fecha_fin.value,
        )
        ...
        try:
            historico_activo2 = fa.rava.get_history(
                ticker2.value,
                fecha_ini.value,
                fecha_fin.value,
            )
    ...
    ticker1 = ft.TextField(
        label='Ticker 1',
        tooltip='Para los distintos tipos de dólares usar:\n'\
                'DOLAR MEP, DOLAR CCL, DOLAR OFICIAL.',
        value='AL30',
    )
    ticker2 = ft.TextField(
        label='Ticker 2',
        tooltip='Para los distintos tipos de dólares usar:\n'\
                'DOLAR MEP, DOLAR CCL, DOLAR OFICIAL.',
        value='AL30D'
    )
    fecha_ini = ft.TextField(
        label='Fecha Desde',
        tooltip='(aaaa-mm-dd)',
        value='2022-01-01',
    )
    ...
    contenedor_boton_calcular = ft.Container(
